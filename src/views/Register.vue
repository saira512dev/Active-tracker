<template>
  ...
  <form @submit.prevent="register" class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
    ...
    <div class="flex flex-col mb-2">
      ...
      <input id="email" v-model="email" type="text" required class="p-2 text-gray-500 focus:outline-none">
    </div>
    <div class="flex flex-col mb-2">
      <label for="password" class="mb-1 text-sm text-at-light-green">Password</label>
      <input id="password" v-model="password" type="text" required class="p-2 text-gray-500 focus:outline-none">
    </div>
    <div class="flex flex-col mb-2">
      <label for="confirmPassword" class="mb-1 text-sm text-at-light-green">Confirm Password</label>
      <input id="confirmPassword" v-model="confirmPassword" type="text" required class="p-2 text-gray-500 focus:outline-none">
    </div>
