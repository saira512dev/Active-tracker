  ...
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <div v-if="dataLoaded">
        ...
        <div
          ...
          >
            ...
            >
              ...
              <img v-if="edit" @click="deleteExercise(item.id)"
                class="absolute h-4 w-auto -left-5 cursor-pointer"
                src="@/assets/images/trash-light-green.png"
                alt="trash"
              />
            </div>
            <button v-if="edit" @click="addExercise"
              type="button"
              class="mt-6 px-6 rounded-sm self-start  text-sm text-white bg-at-light-green
          ...
          v-for="(item, index) in data.exercises" :key="index">
            ...
            <img v-if="edit" class="absolute h-4 w-auto -left-5 cursor-pointer" @click="deleteExercise(item.id)"
            src="@/assets/images/trash-light-green.png" alt="trash" />
          </div>
          <button v-if="edit" type="button" @click="addExercise"
          class="mt-6 px-6 rounded-sm self-start  text-sm text-white bg-at-light-green
            duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white
            hover:text-at-light-green">
            Add Exercise
      ...
      <button
        ...
        type="button"
        @click="update"
        class="mt-10 px-6 rounded-sm self-start  text-sm text-white bg-at-light-green
            duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white
            hover:text-at-light-green"
      >
        Update Workout
